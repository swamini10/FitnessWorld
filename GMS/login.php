...
form button {
  ...
  background-color: #f8bc1a!important;
  border: none;
  border-radius: 4px;
  box-sizing: border-box;
  box-shadow: none;
...
form .inputGroup2 #showPasswordToggle input:disabled ~ .indicator:after {
  ...
  <div class="svgContainer">
    <div>
      <svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
        ...
        <circle cx="100" cy="100" r="100" fill="#f8bc1a"/>
        <g class="body">
  ...
  <div class="inputGroup inputGroup1">
    ...
    <input type="email" name="username" id="loginEmail" maxlength="254" />
...
if(isset($_POST['login'])){
    ...
    $exeque     = mysqli_query($conn , $checkLogin);
    if(mysqli_num_rows($exeque) > 0){
